...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://mybot_db_user:ltpVKyTt2jyK17koidMme91m9u9UvkzD@dpg-cf2p1802i3mnjcgl1v50-a.oregon-postgres.render.com/mybot_db"
db = SQLAlchemy(app)
CORS(app)
## Database
