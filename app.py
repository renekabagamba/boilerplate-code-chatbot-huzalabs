...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://chatbot_9umm_user:3Q2L15rAFLBdFlISarqXhXx341ErrdhU@dpg-cf35ug94reb5o47bg830-a.frankfurt-postgres.render.com/chatbot_9umm"
db = SQLAlchemy(app)
CORS(app)
## Database
